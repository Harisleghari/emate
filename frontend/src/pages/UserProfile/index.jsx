        ...
        <div className="h-full bg-gray-200 p-8">
            <div className="bg-white rounded-lg shadow-xl pb-8">
                <div className="absolute right-12 mt-4 rounded">
                    <button onClick={() => setOpenSettings(!openSettings)} className="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
                    ...
                    <div style={{ display: openSettings ? 'block' : 'none' }} onClick={() => setOpenSettings(false)} className="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl">
