                        ...
                        <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
                            ...
                            <div className="flex flex-col max-w-md space-y-5">
                                <form className="flex flex-col max-w-md space-y-5" onSubmit={handleSubmit}>
                                    ...
                                    <button type='submit' className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Confirm</button>
                                </form>
